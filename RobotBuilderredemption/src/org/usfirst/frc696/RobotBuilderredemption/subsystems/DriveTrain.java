...
public class DriveTrain extends Subsystem {
    ...
    SpeedController centerRightTalon = RobotMap.driveTraincenterRightTalon;
    SpeedController centerLeftTalon = RobotMap.driveTraincenterLeftTalon;
    ...
    public void tankDrive(double leftJoystickValue, double rightJoystickValue) {
        ...
        robotDrive2.tankDrive(leftJoystickValue, rightJoystickValue);
    }

    public void arcadeDrive(double move, double turn) {
        robotDrive.arcadeDrive(move, turn);
        centerLeftTalon.set(move + turn);
        centerRightTalon.set(-(move - turn));
    }
    ...
    public boolean arcadePIDDrive(double speed, double distance, double turn) {
        ...
        if (distance > 0) {
            ...
            robotDrive2.arcadeDrive(speed, -turnController.getOutput());
            ...
            robotDrive2.arcadeDrive(-speed, 0);//-turnController.getOutput());
    ...
    public void shiftingDrive(double leftWantedSpeed, double rightWantedSpeed) {//not done yet
        ...
        oldShifted = shifted;
        robotDrive2.tankDrive(leftDrivePow, rightDrivePow);
