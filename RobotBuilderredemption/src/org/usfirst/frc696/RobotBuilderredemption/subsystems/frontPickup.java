 ...
 *
 */
public class frontPickup extends Subsystem {
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    SpeedController right = RobotMap.frontPickupRight;
    SpeedController left = RobotMap.frontPickupLeft;
    Solenoid deploy = RobotMap.frontPickupdeploy;
