...
public class Robot extends IterativeRobot {
    ...
    public void teleopPeriodic() {
        ...
        RobotMap.pickUppickUpLeft.set(-pickUpRollerRocker);
        RobotMap.pickUppickUpRight.set(pickUpRollerRocker); 
        ...
        if(button[6]){
            ...
            RobotMap.pickUppickUpRight.set(-0.8);
            RobotMap.pickUppickUpLeft.set(0.8);       
        }
