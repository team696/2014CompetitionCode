...
public class Robot extends IterativeRobot {
    ...
    public void teleopPeriodic() {
        ...
        if(button[1]){
            RobotMap.pickUpfrontPickUpLeft.set(-pickUpRollerRocker);
            RobotMap.pickUpfrontPickUpRight.set(pickUpRollerRocker); 
        }else if(button[3]){
            RobotMap.pickUpfrontPickUpLeft.set(pickUpRollerRocker);
            RobotMap.pickUpfrontPickUpRight.set(-pickUpRollerRocker); 
        }else{
            if(button[1]){
            RobotMap.pickUpfrontPickUpLeft.set(0.0);
            RobotMap.pickUpfrontPickUpRight.set(0.0); 
        }
        }
        //.out.println("  Stick  "+joyStick.getRawAxis(2));
        if (fastTurn) {           
            ...
            /*if (stick >= 0) {
                rightDriveVal = (stick) + ((-1 * (wheel * (1.15 - stick))) / 1.1);
                leftDriveVal = stick + ((wheel * (1.15 - stick)) / 1.1);
            } else {//switch left and right driveval around if want like a car
                leftDriveVal = (stick) + (((wheel * (1.15 + (stick)))) / 1.1);
                rightDriveVal = (stick) + ((-1 * (wheel * (1.15 + (stick)))) / 1.1);
            }*/
        ...
        pickUpDown = button[2];
        RobotMap.catchercatcherOpen.set(button[1]);
        ...
        /*if(button[5]){
            RobotMap.pickUppickUpLeft.set(-1);
            RobotMap.pickUppickUpRight.set(1);
        }else if(button[7]){
            RobotMap.pickUppickUpLeft.set(1);
            RobotMap.pickUppickUpRight.set(-1);
        }else{
            RobotMap.pickUppickUpLeft.set(0);
            RobotMap.pickUppickUpRight.set(0);
        }*/
        ...
        //Robot.driveTrain.shiftingDrive(stick*17, stick*17);
        ...
        RobotMap.driveTrainshiftingSolenoid.set(shifted);
        //System.out.println(leftDriveSetVal+"   "+rightDriveSetVal);
        //RobotMap.driveTrainRobotDrive.tankDrive(leftDriveSetVal, rightDriveSetVal);
