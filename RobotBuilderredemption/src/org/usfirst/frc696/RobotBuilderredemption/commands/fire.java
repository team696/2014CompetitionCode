...
public class  fire extends Command {
    ...
    protected boolean isFinished() {
        System.out.println((!Robot.shooter.getSwitch()&&(!Robot.shooter.getSwitch2())&&(shootTimer.get()>0.4)) || shootTimer.get()>1.5);
        if((Robot.shooter.getSwitch()&&(shootTimer.get()>0.3)) || shootTimer.get()>1.5){
